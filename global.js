function calculateBirthDay() {
		...
		var month = prompt("Please enter the month that you were born: ")
		month--; //Month is a zero based number, decremeting by 1 converts it to computer readable code 
		var day = prompt("Please enter the day that you were born: ")
